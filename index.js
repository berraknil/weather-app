$(document).ready(function() {
    ...
    function Forecast(data) {
        ...
        this.hour = data.forecast.txt_forecast.date;
        this.currentF = Math.round(d.temp_f);
    ...
    //weather icons
    var icons = {
        clear: 'icons/0clear.svg',
        cloudy: 'icons/0cloudy.svg',
        flurries: 'icons/0flurries.svg',
        fog: 'icons/0fog.svg',
        haze: 'icons/0haze.svg',
        mostlyCloudy: 'icons/0mostlycloudy.svg',
        mostlySunny: 'icons/0clear.svg',
        partlyCloudy: 'icons/0partlycloudy.svg',
        partlySunny: 'icons/0partlycloudy.svg',
        freezingRain: 'icons/0freezingrain.svg',
        rain: 'icons/0rain.svg',
        sleet: 'icons/0sleet.svg',
        snow: 'icons/0snow.svg',
        sunny: 'icons/0clear.svg',
        thunderstorms: 'icons/0thunderstorm.svg',
        thunderstorm: 'icons/0thunderstorm.svg',
        unknown: 'icons/0unknown.svg',
        overcast: 'icons/0overcast.svg',
        scatteredClouds: 'icons/0scatteredclouds.svg'
    };

    //API Request
    $.ajax({
        url: 'https://api.wunderground.com/api/6b256b790612d6d5/forecast/conditions/q/autoip.json',
        dataType: 'jsonp',
